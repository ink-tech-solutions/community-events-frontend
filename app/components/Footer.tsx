            ...
            <Container>
                <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
                    <div className="lg:col-span-2">
                        ...
                        <div className="max-w-md mt-4 text-gray-500 dark:text-white">
                        ...
                        <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
                            {navigation.map((item, index) => (
                                <Link
                                    key={index}
                                    href="/"
                                    className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-white hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-trueGray-700"
                                >
                                    {item}
                                </Link>
                            ))}
                    ...
                    <div className="">
                        <div className="dark:text-white">Follow us</div>
                        <div className="flex mt-5 space-x-5 text-gray-400 dark:text-white">
